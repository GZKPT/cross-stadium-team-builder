...
- Apri **Mostra analisi** sotto i sei slot per vedere le debolezze e resistenze difensive e la copertura delle mosse d’attacco selezionate. La tabella usa i 18 tipi e la tabella moderna adottata da Cross Stadium, incluse le interazioni introdotte dopo la prima generazione; i moltiplicatori offensivi considerano le quattro mosse impostate per ogni Pokémon.
